...
<div class="portlet light portlet-fit portlet-form bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red sbold uppercase">{{__('site.addRestaurant')}} </span>
        </div>
        <div class="actions">
        </div>
    </div>
        ...
        <div class="form-body">
            <div class="form-group {{ $errors->has('RestaurantName') ? ' has-error' : '' }}">
                <div class="input-icon">
                    ...
                    {!! Form::text('RestaurantName',old('RestaurantName'),['class'=>'form-control placeholder-no-fix','placeholder'=>__('site.restaurantName'),'autocomplete'=>'off']) !!}
            ...
            <div class="form-group {{ $errors->has('RestaurantPhone') ? ' has-error' : '' }}">
                <div class="input-icon">
                    ...
                    {!! Form::text('RestaurantPhone',old('RestaurantPhone'),['class'=>'form-control placeholder-no-fix','placeholder'=>__('site.restaurantPhone'),'autocomplete'=>'off']) !!}
